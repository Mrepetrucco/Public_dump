...
Lineage: consolidates v1.1 (19 Jul) + v1.2 currency delta (19 Jul) + v1.3 delta (20 Jul, compute-first / framework-on-delegation) + LEAN7POF2_AX7_v1_update_pack (30 Jul) + v1.4 (31 Jul, AX7 v1.0 spine) + v2.1 delta (13 Aug, native footer schema v2.3 (single source, Reconciler-owned; native-only): exemptions eliminated, 5-field meter incl. TMU, j_profile binding). All prior text is carried ADDITIVELY; nothing below relaxes a v1.3 boundary.
...
*— LEAN7POF2 V2.1 (v2.1) · external portable edition · reduced set R1–R7 · AX7 v1.0 spine · portable floor mandatory · native footer schema v2.3 (single source, Reconciler-owned; native-only) (Claude-side; exemptions eliminated) · native-mode embedded Reconciler required · Claude-only accelerators excluded by design —*
